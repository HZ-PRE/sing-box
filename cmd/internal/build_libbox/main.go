...
func init() {
	...
	sharedFlags = append(sharedFlags, "-ldflags", "-X github.com/HZ-PRE/sing-box/constant.Version="+currentTag+" -s -w -buildid=")
	debugFlags = append(debugFlags, "-ldflags", "-X github.com/HZ-PRE/sing-box/constant.Version="+currentTag)
